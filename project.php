...
if($_GET['id']=="brandtest1"){
	$contents='<h1 class="text-center">
			<a href=\'https://brandtest.site\' target=\'_blank\'>명품 브랜드 테스트</a>
		</h1>
...
if($_GET['id']=="brandtest2"){
	$contents='		<h1 class="text-center">
		...
		<div class="d-flex flex-column mb-3 text-center mt-5">
			...
			<div class=\'m-3\'>
				[사진 2-1]과 같이 파이썬 셀레니움을 이용해서 구글 이미지를 크롤링했습니다. 크롤링을 한 키워드는 \'OO(브랜드 이름) 컬렉션\'입니다. 검색을 통해 나오는 [사진 2-2]와 같은 각 명품 브랜드의 컬렉션 사진을 각 브랜드당 200장 정도 자동으로 수집했습니다. 그리고 [사진 2-3]과 같이 직접 모든 사진을 가공했습니다. 사람의 얼굴이나 주변 배경에 의해서 결과가 바뀌는 것을 최대한 줄이기 위해서 배경과 사람의 머리를 최대한 제외한 부분을 학습 데이터로서 사용했습니다.<br>
			</div>
